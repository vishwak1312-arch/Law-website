...
export const siteConfig = {
  ...
  attorney: process.env.NEXT_PUBLIC_ATTORNEY_NAME || "James Mitchell",
  ...
  phone: process.env.NEXT_PUBLIC_ATTORNEY_PHONE || "(555) 234-5678",
  email: process.env.NEXT_PUBLIC_ATTORNEY_EMAIL || "contact@mitchelllaw.com",
  emergencyPhone: "(555) 234-9999",
  address: process.env.NEXT_PUBLIC_OFFICE_ADDRESS || "1200 Legal Avenue, Suite 450, New York, NY 10001",
  whatsapp: process.env.NEXT_PUBLIC_ATTORNEY_WHATSAPP || "15552345678",
