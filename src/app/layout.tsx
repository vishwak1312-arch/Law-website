...
export const metadata: Metadata = {
  ...
  keywords: ["law firm", "attorney", "legal services", "lawyer", "corporate law", "family law", "criminal defense", "New York attorney"],
  openGraph: {
    type: "website",
    locale: "en_US",
    url: siteConfig.url,
  ...
  "@graph": [
    {
      ...
      address: { "@type": "PostalAddress", streetAddress: "1200 Legal Avenue, Suite 450", addressLocality: "New York", addressRegion: "NY", postalCode: "10001", addressCountry: "US" },
