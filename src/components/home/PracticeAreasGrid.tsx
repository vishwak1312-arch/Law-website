            ...
            return (
              <FadeUp key={area.slug} delay={i * 0.05}>
                <Link href={`/practice-areas/${area.slug}`} className="group block h-full">
                  <div className="bg-white rounded-xl p-6 h-full border border-gray-100 shadow-sm hover:shadow-xl hover:border-navy/30 transition-all duration-500 hover:-translate-y-1 relative overflow-hidden">
                    {/* Gold top accent on hover */}
                    <div className="absolute top-0 left-0 right-0 h-0.5 bg-navy scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />

                    <div className="w-12 h-12 rounded-lg bg-navy/5 flex items-center justify-center mb-4 group-hover:bg-navy/10 transition-colors duration-500">
                      <Icon className="w-6 h-6 text-navy group-hover:text-navy transition-colors duration-500" />
                    </div>
                    ...
                    <span className="text-navy text-sm font-semibold group-hover:gap-2 inline-flex items-center gap-1 transition-all duration-300">
                      Learn More →
                    </span>
                  </div>
                </Link>
